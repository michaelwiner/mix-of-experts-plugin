...
Create this file at `.claude/mix-of-experts-plugin.local.md` in your project root (or `~/.claude/mix-of-experts-plugin.local.md` for global config).
...
This uses the default models: GPT-5.2, Gemini 3 Flash Preview, Deepseek V3.2.
